...
describe('Tailwind CSS Configuration - Industrial Design Tokens', () => {
  ...
  describe('Industrial Color Palette', () => {
    describe('Orange Palette', () => {
      ...
      it('should set orange-400 as DEFAULT', () => {
        expect(configContent).toMatch(/orange:\s*{[\s\S]*?DEFAULT:\s*'var\(--industrial-orange-400\)'/);
      });
    });

    describe('Graphite Palette', () => {
      it('should define all graphite shades', () => {
        expect(configContent).toContain("100: 'var(--industrial-graphite-100)'");
        expect(configContent).toContain("200: 'var(--industrial-graphite-200)'");
        expect(configContent).toContain("300: 'var(--industrial-graphite-300)'");
        expect(configContent).toContain("400: 'var(--industrial-graphite-400)'");
        expect(configContent).toContain("500: 'var(--industrial-graphite-500)'");
        expect(configContent).toContain("600: 'var(--industrial-graphite-600)'");
      });

      it('should set graphite-600 as DEFAULT', () => {
        expect(configContent).toMatch(/graphite:\s*{[\s\S]*?DEFAULT:\s*'var\(--industrial-graphite-600\)'/);
      });
    });
    ...
    describe('Navy Palette', () => {
      ...
      it('should set navy-400 as DEFAULT', () => {
        expect(configContent).toMatch(/navy:\s*{[\s\S]*?DEFAULT:\s*'var\(--industrial-navy-400\)'/);
      });
    });

    describe('Background Colors', () => {
      it('should define industrial background colors', () => {
        expect(configContent).toContain("primary: 'var(--industrial-bg-primary)'");
  ...
  describe('Border Radius Extensions', () => {
    it('should define industrial-sharp border radius', () => {
      expect(configContent).toContain("'industrial-sharp': 'var(--industrial-radius-sharp)'");
    });

    it('should define industrial-base border radius', () => {
      expect(configContent).toContain("'industrial-base': 'var(--industrial-radius-base)'");
    });
  ...
  describe('Border Width Extensions', () => {
    it('should define industrial border widths', () => {
      expect(configContent).toContain("'industrial-thin': 'var(--industrial-border-thin)'");
      expect(configContent).toContain("'industrial-base': 'var(--industrial-border-base)'");
      expect(configContent).toContain("'industrial-thick': 'var(--industrial-border-thick)'");
      expect(configContent).toContain("'industrial-category': 'var(--industrial-border-category)'");
    });
  });

  describe('Spacing Scale Extensions', () => {
    it('should define all industrial spacing values', () => {
      expect(configContent).toContain("'industrial-xs': 'var(--industrial-space-xs)'");
      expect(configContent).toContain("'industrial-sm': 'var(--industrial-space-sm)'");
      expect(configContent).toContain("'industrial-md': 'var(--industrial-space-md)'");
      expect(configContent).toContain("'industrial-base': 'var(--industrial-space-base)'");
      expect(configContent).toContain("'industrial-lg': 'var(--industrial-space-lg)'");
      expect(configContent).toContain("'industrial-xl': 'var(--industrial-space-xl)'");
      expect(configContent).toContain("'industrial-2xl': 'var(--industrial-space-2xl)'");
      expect(configContent).toContain("'industrial-3xl': 'var(--industrial-space-3xl)'");
      expect(configContent).toContain("'industrial-4xl': 'var(--industrial-space-4xl)'");
    });
  });
