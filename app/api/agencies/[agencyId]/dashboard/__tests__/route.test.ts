...
describe('GET /api/agencies/[agencyId]/dashboard', () => {
  const mockUser = {
    id: '123e4567-e89b-12d3-a456-426614174000',
    email: 'owner@example.com',
  };

  const mockAgencyId = 'agency-123e4567-e89b-12d3-a456-426614174000';
  ...
  describe('Parameter Validation', () => {
    it('should return 400 when agencyId is missing', async () => {
      const invalidParams = { params: { agencyId: '' } };
      ...
      expect(data.error.message).toBe('Invalid agency ID');
    });

    it('should return 400 when agencyId is not a string', async () => {
      const invalidParams = { params: { agencyId: null as any } };
