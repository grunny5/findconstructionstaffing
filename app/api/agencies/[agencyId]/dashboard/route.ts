...
export async function GET(
  ...
  try {
    ...
    // Validate agencyId parameter
    if (!agencyId || typeof agencyId !== 'string') {
      monitor.complete(HTTP_STATUS.BAD_REQUEST, 'Invalid agency ID');
      return NextResponse.json(
        {
          error: {
            ...
            details: {
              agencyId: 'Must be a valid UUID string',
            },
          },
        },
    ...
    errorTracker.recordRequest('GET /api/agencies/[agencyId]/dashboard', false);
    ...
    errorTracker.recordRequest('GET /api/agencies/[agencyId]/dashboard', true);

    console.error(
      'Unexpected error in GET /api/agencies/[agencyId]/dashboard:',
      {
