...
/**
 * Industrial Design System - Toast Component
 *
 * Uses industrial color palette:
 * - default: industrial-bg-card with graphite border
 * - destructive: industrial-orange styling (not bright red)
 */
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-industrial-sharp border-2 p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full',
  {
    variants: {
      variant: {
        default:
          'border-industrial-graphite-300 bg-industrial-bg-card text-industrial-graphite-600',
        destructive:
          'destructive group border-industrial-orange bg-industrial-orange-100 text-industrial-graphite-600',
      },
    },
    defaultVariants: {
      variant: 'default',
